        ...
        <tbody>
            ...
            @foreach ($clientes as $cliente)
                ...
                <!-- botones para llamado a la accion -->
                        <button type="button" class="btn btn-info" style="background-color: #90b8f5; border-color: #90b8f5;" onclick="location.href='{{route('cliente.show', $cliente->id)}}'">Ver</button>
                        <button type="button" class="btn btn-warning" style="background-color: #e6e6fa; border-color: #e6e6fa;" onclick="location.href='{{route('cliente.edit', $cliente->id)}}'">Editar</button>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#cliente{{$cliente->id}}">Eliminar</button>
