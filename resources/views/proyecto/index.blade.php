        ...
        <tbody>
            ...
            @foreach ($proyectos as $proyecto)
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-info" style="background-color: #90b8f5; border-color: #90b8f5;" onclick="location.href='{{route('proyecto.show', $proyecto->id)}}'">ver</button>
                        <button type="button" class="btn btn-warning" style="background-color: #e6e6fa; border-color: #e6e6fa;"  onclick="location.href='{{route('proyecto.edit', $proyecto->id)}}'">Editar</button>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#proyecto{{$proyecto->id}}">Eliminar</button>
                        <!-- Modal eliminar -->
